...
<html lang="en">
  <head>
    <title>WarungBuAsih</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    
    <link href="https://fonts.googleapis.com/css?family=Playfair+Display:400,400i,700|Raleway" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('tamplate/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('tamplate/css/open-iconic-bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('tamplate/css/animate.css')}}">
    
    <link rel="stylesheet" href="{{asset('tamplate/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('tamplate/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{asset('tamplate/css/magnific-popup.css')}}">

    <link rel="stylesheet" href="{{asset('tamplate/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{asset('tamplate/css/jquery.timepicker.css')}}">

    

    <link rel="stylesheet" href="{{asset('tamplate/css/icomoon.css')}}">
...
@endif
    ...
    <nav class="navbar navbar-expand-lg navbar-dark site_navbar bg-dark site-navbar-light" id="site-navbar">
      <div class="container">
        <a class="navbar-brand" href="index.html">WarungBuAsih</a>
    ...
    <section class="site-cover" style="background-image: url(tamplate/images/bg.png);" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center site-vh-100">
          <div class="col-md-12">
            <h1 class="site-heading site-animate">Welcome To WarungBuAsih</h1>
            <h2 class="h5 site-subheading mb-5 site-animate">Come and eat well with our delicious &amp; healthy foods.</h2>    
            <!-- <p><a href="{{url('check')}}" class="">Login</a></p> -->
            @guest
<p><button type="button" class="btn btn-outline-white btn-lg site-animate" data-toggle="modal" data-target="#LoginModal">Login</button></p>

@else

		@if(Auth::user()->isAdmin == 1)
                <a class="btn btn-outline-white btn-lg site-animate text-uppercase" href="/admin/dashboard">
                @if(!empty(Auth::user()->name))
                    {{Auth::user()->name}}
                @endif</a>
                @elseif(Auth::user()->isAdmin == 0)
                <a class="btn btn-outline-white btn-lg site-animate text-uppercase" href="/user/dashboard">
                @if(!empty(Auth::user()->name))
                    {{Auth::user()->name}}
                @endif</a>
                @endif
...
<div class="modal fade" id="LoginModal" tabindex="-1" role="dialog" aria-labelledby="LoginModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
        ...
        @csrf
          ...
          <div class="form-group">
            ...
            <a href="{{route('check')}}" class="pl-5 small text-danger">Lupa email & password ?</a>
          </div>
        </form>
      </div>
    ...
    <script src="{{asset('tamplate/js/popper.min.js')}}"></script>
    <script src="{{asset('tamplate/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('tamplate/js/jquery.easing.1.3.js')}}"></script>
    <script src="{{asset('tamplate/js/jquery.waypoints.min.js')}}"></script>
    <script src="{{asset('tamplate/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('tamplate/js/jquery.magnific-popup.min.js')}}"></script>

    <script src="{{asset('tamplate/js/bootstrap-datepicker.js')}}"></script>
    <script src="{{asset('tamplate/js/jquery.timepicker.min.js')}}"></script>
    
    <script src="{{asset('tamplate/js/jquery.animateNumber.min.js')}}"></script>
    

    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
    <script src="{{asset('tamplate/js/google-map.js')}}"></script>
